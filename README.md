<div align="center">
    ...
    <tr>
      <td><p> ~ ing : [중계 관리자/고객] STG/PRD 모의해킹 취약점 진단 내역 조치 </p></td>
    </tr>
    <tr>
      <td><p> ~ ing : [중계 고객] 영업, 마케팅계정 메시지 전송결과 전체 조회 및 RCS_ID 파라미터 갯수초과 조회불가 수정 </p></td>
    </tr>
    <tr>
      <td><p> ~ ing : [중계] PBS 챗봇별 통계 데이터 포탈 조회 쿼리 개발 검토중 </p></td>
    </tr>
    <tr>
      <td><p> ~ ing : [중계 관리자] 메시지 전송 결과 조회 10만건 제한 상향 조정 및 성능개선 검토중</p></td>
    </tr>
    <tr>
