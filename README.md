...
<!--         <h4> 서비스플랫폼_SM개발_메시지 (RCS 홀세일 / RCS 중계) </h4> -->
    ...
    <tr>
      <td>
        <details open>
            <summary>진행중</summary>
            <p> ~ ing : [중계 고객] 이미지&타이틀 상조형 소제목 2개만 입력 가능(가이드: 최대 3개)</p>
            <p> ~ ing : [중계 고객] 2024년 개인정보 이용 제공 내역 통지 시행 요청</p>
            <p> ~ ing : [중계 관리자] 포탈 메시지 결과 전체 조회 사 조회 안됨</p>
            <p> ~ ing : [중계 관리자] 과금통계 전체조회 시 TypeERROR발생</p>
        </details>
      </td>    
    </tr>
    <tr>
